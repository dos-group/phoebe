package de.tu_berlin.dos.phoebe.clients.generators;
...
public class GeneratorsClient {
    ...
    public final GeneratorsRest service;
    HttpLoggingInterceptor logging = new HttpLoggingInterceptor();

    public GeneratorsClient(String baseUrl, Gson gson) {
        ...
        this.service = retrofit.create(GeneratorsRest.class);
    }
